            ...
            <q-card bordered  flat  class="q-pa-md q-mb-md no-border-radius shadow-1">
                <div class="container">
                    <div class="row justify-between q-col-gutter-md">
                        <div class="col ">
                            <div class="text-h6 text-bold record-title">Edit Test</div>
                        </div>
                    </div>
                </div>
            </q-card>
                            ...
                            <div>
                                <div v-if="!loading">
                                    <ValidationObserver ref="observer" v-slot="{ invalid }" tag="form" @submit.prevent="startRecordUpdate()">
                                        <input name="ctrlpost"  ref="ctrlpost" v-model="formData.post" type="hidden" />
...
<script>
	...
	export default {
		...
		methods: {
			...mapActions('test', ['updateRecord', 'fetchRecord']),
