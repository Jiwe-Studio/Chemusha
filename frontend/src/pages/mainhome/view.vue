            ...
            <q-card bordered  flat  class="q-pa-md q-mb-md no-border-radius shadow-1">
                <div class="container">
                    <div class="row justify-between q-col-gutter-md">
                        <div class="col ">
                            <div class="text-h6 text-bold record-title">View Mainhome</div>
                        </div>
                    </div>
                </div>
            </q-card>
                            ...
                            <div>
                                <div v-if="!loading">
                                    <div v-if="item" class="page-records ">
                                        ...
                                        <div class="q-pa-sm">
                                            <q-btn    :rounded="false"  no-caps  unelevated   size="sm" padding="xs" color="accent" icon="las la-edit"  class="q-mx-xs" title="Edit This Record"  :to="`/mainhome/edit/${item.id }`">
                                            </q-btn>
...
<script>
	...
	export default {
		...
		props: {
			...
			routeName : {
				type : String,
				default : 'mainhomeview',
			},
			apiPath: {
				type : String,
				default : 'mainhome/view',
			},
		},
		data() {
            return {
		...
		methods: {
			...mapActions("mainhome", [ "fetchRecord", "deleteRecord"]),
		},
		watch: {
			$route (to, from){
