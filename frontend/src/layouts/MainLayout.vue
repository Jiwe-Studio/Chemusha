        ...
        <template v-if="$isLoggedIn">
            <q-header  style="border-bottom-left-radius:20px; border-bottom-right-radius:20px;">
                <q-toolbar class="  ">
                    ...
                    <q-btn-dropdown no-caps stretch unelevated icon="las la-user">
                        <q-list dense style="min-width:200px">
                            <q-item  clickable v-ripple to="/account">
                                <q-item-section avatar>
                                    <q-avatar icon="las la-user"></q-avatar>
                                </q-item-section>
                                <q-item-section>
                            ...
                            <q-item  clickable v-ripple @click="startLogout()">
                                <q-item-section avatar>
                                    <q-avatar icon="las la-sign-out-alt"></q-avatar>
                                </q-item-section>
                                <q-item-section>
            ...
            <q-drawer v-model="leftDrawer" show-if-above :width="250" :breakpoint="500" bordered   :mini="leftDrawerMini">
                <q-scroll-area class="fit   ">
                    <div class="text-center bg-primary q-pt-md">
                        <q-icon size="50px" color="white" name="las la-user"></q-icon>
                ...
                <div class="container-fluid">
                    <q-banner inline-actions>
                        ...
                        <template v-slot:action>
                            <q-btn flat icon="las la-times-circle" @click="pageErrors = []"></q-btn>
                        </template>
                    </q-banner>
                </div>
            </q-card>
